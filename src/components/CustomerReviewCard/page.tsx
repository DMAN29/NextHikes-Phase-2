...
export default function CustomerReviewCard({
  ...
  return (
    <div className="relative rounded-2xl flex flex-col bg-gradient-to-br from-[#1a1a1a] to-[#0d0d0d] text-white p-6 shadow-lg overflow-hidden h-[450px]">
      ...
      <div className="pt-[70px] pb-5">
        ...
        <div className="mb-6">
          ...
          <p
            className="text-sm md:text-xl leading-relaxed text-gray-200 line-clamp-6"
