...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    const presets = {
      low: { scale: 0.4, fpsCap: 45, layers: 1.0 },
      medium: { scale: 0.5, fpsCap: 30, layers: 2.0 },
      high: { scale: 1.0, fpsCap: 60, layers: 4.0 },
    };
    const preset = presets[performance] || presets.medium;
    const renderScale = preset.scale;
    const fpsCap = preset.fpsCap;
